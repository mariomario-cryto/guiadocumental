...
export default function AssessoriaPrimeiraGuia() {
  ...
  function validar(): boolean {
    ...
    if (!form.dataNascimento) novosErros.dataNascimento = "Informe sua data de nascimento";
    if (!form.estado) novosErros.estado = "Selecione seu estado";
    if (!form.possuiRG) novosErros.possuiRG = "Selecione uma opção";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/leads", {
        ...
        body: JSON.stringify({ ...form, tipo: "primeira-via" }),
      });
      ...
      <div className="bg-gradient-to-r from-primary to-primary-dark">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="text-white/80 max-w-2xl">
            ...
            seus dados e entrará em contato para orientá-lo em cada etapa.
          </p>
        </div>
      </div>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Seu nome completo como no RG"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 rounded-xl border ${erros.dataNascimento ? "border-red-400 bg-red-50" : "border-border"} focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all text-sm`}
                />
            ...
            <div className="space-y-5">
              <div>
                <label className="block text-sm font-medium text-text mb-2">
                  Você já possui RG (Carteira de Identidade)? *
                </label>
                  ...
                  {["sim", "nao"].map((opt) => (
                    ...
                    >
                      <input
                        ...
                        name="possuiRG"
                        value={opt}
                        checked={form.possuiRG === opt}
                        onChange={handleChange}
                        className="sr-only"
                      />
                      {opt === "sim" ? "Sim, possuo" : "Não possuo"}
                    </label>
                  ))}
                </div>
                {erros.possuiRG && (
                  <p className="text-red-500 text-xs mt-1">{erros.possuiRG}</p>
                )}
              </div>
